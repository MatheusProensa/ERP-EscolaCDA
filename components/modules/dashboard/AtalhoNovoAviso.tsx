 ...
 * mas abre o modal de criação direto em vez de só navegar pro Mural (era
 * exatamente o mesmo link que já existe na sidebar, sem ganho nenhum). */
    ...
    <>
      ...
      >
        <span
          ...
          style={{ backgroundColor: `color-mix(in oklch, ${COR} 14%, white)` }}
        >
          <Megaphone className="h-4 w-4" style={{ color: COR }} strokeWidth={2.25} />
        </span>
        Novo aviso
      </button>
