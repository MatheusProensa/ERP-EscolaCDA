...
const REGRAS_ACESSO: { prefixo: string; roles: RoleAtiva[] }[] = [
  ...
  { prefixo: "/festa-familia", roles: ADMINISTRATIVO },
  ...
  { prefixo: "/api/festa-familia", roles: ADMINISTRATIVO },
...
export const MODULOS: { chave: string; label: string; prefixos: string[] }[] = [
  ...
  { chave: "festa-familia", label: "Festa da Família", prefixos: ["/festa-familia", "/api/festa-familia"] },
