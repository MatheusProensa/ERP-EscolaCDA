...
import { formatarTelefone, agruparPorSetor, SETORES, dataArquivo } from "@/lib/utils";
...
export async function GET(request: NextRequest) {
  ...
  if (params.get("formato") === "pdf") {
    ...
    return respostaPDF(pdf, nomeArquivoPdf("Contatos Equipe", dataArquivo()));
  }
  ...
  return respostaCSV(csv, `Contatos Equipe - ${dataArquivo()}.csv`);
}
